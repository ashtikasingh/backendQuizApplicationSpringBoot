...
public class QuizController {
    ...
    @PostMapping("create")
    public ResponseEntity<String> createQuiz(@RequestParam String lang, @RequestParam int numQ, @RequestParam String title){
        return quizService.createQuiz(lang, numQ, title);
    }
